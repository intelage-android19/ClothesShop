...
public class TopBrandsUnderProductAdapter  extends RecyclerView.Adapter<TopBrandsUnderProductAdapter.Holder> {

    List<ProductUnderTopBrandModel> itemlist;
    Activity activity;
    AddToCartListener addToCartListener;
    SessionManager sessionManager;

    public TopBrandsUnderProductAdapter(TopBrandsDetailsActivity activity, List<ProductUnderTopBrandModel> productUnderTopBrandModelList) {
        this.itemlist = productUnderTopBrandModelList;
    ...
    @NonNull
    @Override
    public TopBrandsUnderProductAdapter.Holder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        LayoutInflater layoutInflater=LayoutInflater.from(viewGroup.getContext());
        View view=layoutInflater.inflate(R.layout.item_view,null);
        return new TopBrandsUnderProductAdapter.Holder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull TopBrandsUnderProductAdapter.Holder holder, int i) {

        final ProductUnderTopBrandModel current=itemlist.get(i);
        ...
        holder.details.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("price",current.getMrpprice());
                intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                activity.getApplicationContext().startActivity(intent);
            }
        ...
        public Holder(@NonNull View itemView) {
            ...
            addcart.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    ProductUnderTopBrandModel model=itemlist.get(pos);
            ...
            addwishlist.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    int pos=getAdapterPosition();
                    ProductUnderTopBrandModel cartModel=itemlist.get(pos);
